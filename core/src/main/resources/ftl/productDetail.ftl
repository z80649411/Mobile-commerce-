...
<head>
    ...
    <#--使用freemarker语法创建两个变量-->
    <#assign path="http://localhost:8080/portal">
    <#assign file_path="http://localhost:8081/file">
        ...
        <div class="box bg_white">
            <ul class="uls x_150x150">
                <li class="here">
                    ...
                    <a href="#" title="张同来" target="_blank" class="pic"><img src="../res/img/pic/p140X140b.png"
                                                                             alt="摩托罗拉XT319"/></a>
                    <dl>
                        <!-- dt 11个文字+... -->
                    ...
                    <div class="smallBox">
                        <div class="smallList">
                            <a class="cloud-zoom-gallery here" title="red" href="${file_path }${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '../res/img/pic/smallimage.jpg'"><img
                                    alt="thumbnail 1" src="${file_path }${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${file_path }${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '../res/img/pic/smallimage-1.jpg'"><img
                                    alt="thumbnail 2" src="${file_path }${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${file_path }${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '../res/img/pic/smallimage-2.jpg'"><img
                                    alt="thumbnail 3" src="${file_path }${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${file_path }${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '../res/img/pic/smallimage-3.jpg'"><img
                                    alt="thumbnail 4" src="${file_path }${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${file_path }${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '../res/img/pic/smallimage-4.jpg'"><img
